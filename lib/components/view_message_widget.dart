...
import 'view_message_model.dart';
export 'view_message_model.dart';

class ViewMessageWidget extends StatefulWidget {
  const ViewMessageWidget({
    super.key,
    required this.contactUs,
  });

  final ContactUsRecord? contactUs;
...
class _ViewMessageWidgetState extends State<ViewMessageWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewMessageModel());
