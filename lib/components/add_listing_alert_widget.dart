...
import 'add_listing_alert_model.dart';
export 'add_listing_alert_model.dart';

class AddListingAlertWidget extends StatefulWidget {
  const AddListingAlertWidget({super.key});

  @override
  State<AddListingAlertWidget> createState() => _AddListingAlertWidgetState();
}

class _AddListingAlertWidgetState extends State<AddListingAlertWidget> {
  late AddListingAlertModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddListingAlertModel());
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Container(
                    width: double.infinity,
                    height: 100.0,
                    child: custom_widgets.ListingDropDownWidgetNew(
                      width: double.infinity,
                      height: 100.0,
                    ),
                  ),
                    ...
                    onPressed: () async {
                      if (FFAppState().selectedListingCatagoryRef != null) {
                        ...
                        if (FFAppState().listingImage != null &&
                          ...
                          _model.listing = ProductsRecord.getDocumentFromData(
                          ...
                          await _model.listing!.reference.update({
                            ...createProductsRecordData(
                              productRef: _model.listing?.reference,
                            ),
                            ...mapToFirestore(
                              {
