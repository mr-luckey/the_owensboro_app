...
import 'edit_listing_alert_model.dart';
export 'edit_listing_alert_model.dart';

class EditListingAlertWidget extends StatefulWidget {
  const EditListingAlertWidget({
    super.key,
  ...
  @override
  State<EditListingAlertWidget> createState() => _EditListingAlertWidgetState();
}

class _EditListingAlertWidgetState extends State<EditListingAlertWidget> {
  late EditListingAlertModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditListingAlertModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().listingImage = widget!.productDoc!.imageUrl;
      safeSetState(() {});
    ...
    _model.shortDescriptionTextController ??=
        TextEditingController(text: widget!.productDoc?.shortDescription);
    _model.shortDescriptionFocusNode ??= FocusNode();

    _model.aboutTextController ??=
        TextEditingController(text: widget!.productDoc?.about);
    _model.aboutFocusNode ??= FocusNode();

    _model.locationTextController ??=
        TextEditingController(text: widget!.productDoc?.productLocation);
    _model.locationFocusNode ??= FocusNode();

    _model.timeTextController ??= TextEditingController(
        text: widget!.productDoc?.startTimeString != null &&
                widget!.productDoc?.startTimeString != ''
            ? '${widget!.productDoc?.startTimeString} - ${widget!.productDoc?.endTimeString}'
            : widget!.productDoc?.time);
    _model.timeFocusNode ??= FocusNode();

    _model.contactTextController ??=
        TextEditingController(text: widget!.productDoc?.contactInfo);
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Container(
                    width: double.infinity,
                    height: 110.0,
                    child: custom_widgets.EditListingWidgetNew(
                      width: double.infinity,
                      height: 110.0,
                      selectedRef: widget!.productDoc?.catagoryRef,
                      selectedRefSub: widget!.productDoc?.subCatagoryRef,
                    ),
                  ),
                ),
                Column(
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      child: custom_widgets.ListingImageWidget(
                        width: 200.0,
                        height: 200.0,
                        initialImageUrl: widget!.productDoc?.imageUrl,
                    ...
                    onPressed: () async {
                      ...
                      if (FFAppState().listingImage != null &&
                        ...
                        await widget!.productDoc!.reference
                          ...
                          productName: _model.titleTextController.text,
                          productLocation: _model.locationTextController.text,
                          about: _model.aboutTextController.text,
                          contactInfo: _model.contactTextController.text,
                          time: _model.timeTextController.text,
                          imageUrl: FFAppState().listingImage,
                        ));
