...
/// GetX controller for [ListingDetailPageWidget].
class ListingDetailPageController extends GetxController {
  final GlobalKey<ScaffoldState> scaffoldKey = GlobalKey<ScaffoldState>();

  ListingDetailPageModel? model;
  ...
  void initModel(BuildContext context) {
    ...
    model = createModel(context, () => ListingDetailPageModel());
