...
import '/components/delete_review_widget.dart';
import '/components/delete_user_alert_widget.dart';
import '/components/edit_write_review_widget.dart';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ReviewsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ReviewsRecord> listingDetailPageReviewsRecordList = snapshot.data!;
                ...
                children: [
                  Padding(
                    padding: EdgeInsets.all(valueOrDefault<double>(
                      MediaQuery.sizeOf(context).width >= 600.0 ? 20.0 : 20.0,
                      0.0,
                    )),
                        ...
                        children: [
                                          ...
                                          Align(
                                            ...
                                            child:
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                final textCatagoriesRecord =
                                                    snapshot.data!;

                                                return Text(
                                                  textCatagoriesRecord
                                                      .catagoryName,
                                                  maxLines: 1,
                                                  style: FlutterFlowTheme.of(
                                                          context)
                            ...
                            child: Builder(
                              builder: (context) {
                                if (MediaQuery.sizeOf(context).width >= 600.0) {
                                  return Builder(
                                    builder: (context) {
                                      final listingDetailPageVar =
                                          listingDetailPageReviewsRecordList
                                              .toList();

                                      return Column(
                                        mainAxisSize: MainAxisSize.max,
                                        children: List.generate(
                                            listingDetailPageVar.length,
                                            (listingDetailPageVarIndex) {
                                          final listingDetailPageVarItem =
                                              listingDetailPageVar[
                                                  listingDetailPageVarIndex];
                                          return Padding(
                                            padding:
                          ...
                          Align(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                context.pushNamed(
                                  ViewAllReviewsScreenWidget.routeName,
                                  queryParameters: {
                      ...
                      child: Container(
                        ...
                        child: BottomNavBarWidget(
                          ...
                          onGamesTap: () async {
                            ...
                            if (loggedIn) {
                              context
                                  .pushNamed(OwensboroGamesWidget.routeName);
