...
class UserSideSignUpScreenWidget extends StatefulWidget {
  const UserSideSignUpScreenWidget({super.key});

  static String routeName = 'UserSideSignUpScreen';
  static String routePath = '/userSideSignUpScreen';

  @override
  State<UserSideSignUpScreenWidget> createState() =>
