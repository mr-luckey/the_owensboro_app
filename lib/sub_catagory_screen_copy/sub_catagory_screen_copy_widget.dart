...
class SubCatagoryScreenCopyWidget extends StatefulWidget {
  const SubCatagoryScreenCopyWidget({super.key});

  static String routeName = 'SubCatagoryScreenCopy';
  static String routePath = '/subCatagoryScreenCopy';

  @override
  State<SubCatagoryScreenCopyWidget> createState() =>
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            ...
                            fontSize: MediaQuery.sizeOf(context).width >= 450.0
                                ? 50.0
                                : 20.0,
                            letterSpacing: 0.0,
                            fontWeight: FontWeight.bold,
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            20.0, 10.0, 0.0, 0.0),
                                        child: Text(
                                          'Discover the amazing event happening in your city',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                font: GoogleFonts.inter(
