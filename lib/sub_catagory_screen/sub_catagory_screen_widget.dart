...
class SubCatagoryScreenWidget extends StatefulWidget {
  const SubCatagoryScreenWidget({
    super.key,
    required this.subCatagoriesRef,
  });

  final SubCatagoriesRecord? subCatagoriesRef;

  static String routeName = 'SubCatagoryScreen';
  static String routePath = '/subCatagoryScreen';

  @override
  State<SubCatagoryScreenWidget> createState() =>
      _SubCatagoryScreenWidgetState();
}
                                ...
                                StreamBuilder<List<BannerRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return Container(
                                      ...
                                      height: 60.0,
                                      child:
                                          custom_widgets.ScrollableTextWidget(
                                        width: double.infinity,
                                        height: 60.0,
                                      ),
                                    );
                                    ...
                                    return GridView.builder(
                                      ...
                                      itemBuilder: (context, gridViewIndex) {
                                        ...
                                        return InkWell(
                                          ...
                                          highlightColor: Colors.transparent,
                                          onTap: () async {
                                            Get.toNamed(ListingDetailPageWidget.routePath, arguments: {'product': gridViewProductsRecord});
                                          },
                                          child: Container(
                                            width: MediaQuery.sizeOf(context)
                                                    .width *
