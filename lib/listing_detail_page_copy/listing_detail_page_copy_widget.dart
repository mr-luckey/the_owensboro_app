...
class ListingDetailPageCopyWidget extends StatefulWidget {
  const ListingDetailPageCopyWidget({super.key});

  static String routeName = 'ListingDetailPageCopy';
  static String routePath = '/listingDetailPageCopy';

  @override
  State<ListingDetailPageCopyWidget> createState() =>
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    'Discover contemporary art from emerging local artists in this exclusive gallery opening. Network with fellow art lovers while enjoying wine and light refreshments.',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          font: GoogleFonts.inter(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 10.0, 0.0, 0.0),
                                  child: Text(
                                    'Absolutely loved this place! Wide walking paths, clean playgrounds, and great sunset views. Perfect for family afternoons — saw a few food trucks and live music on weekends. Will definitely come back!\"',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          font: GoogleFonts.inter(
