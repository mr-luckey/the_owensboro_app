...
class WheelAdventureScreenWidget extends StatefulWidget {
  const WheelAdventureScreenWidget({super.key});

  static String routeName = 'WheelAdventureScreen';
  static String routePath = '/WheelAdventureScreen';

  @override
  State<WheelAdventureScreenWidget> createState() =>
          ...
          child: Stack(
            children: [
              Align(
                ...
                child: Padding(
                  padding:
                      EdgeInsetsDirectional.fromSTEB(0.0, 230.0, 0.0, 10.0),
                      ...
                      children: [
                        if (responsiveVisibility(
                          ...
                          Container(
                            ...
                            child: custom_widgets.WheelWithFilters(
                              width: MediaQuery.sizeOf(context).width * 0.8,
                              height: MediaQuery.sizeOf(context).height * 0.8,
                              selectedDoc: (product) async {},
                            ),
                          ),
                        if (responsiveVisibility(
                          context: context,
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              height: 400.0,
                              child: custom_widgets.WheelFilterMobile(
                                width: MediaQuery.sizeOf(context).width * 0.9,
                                height: 400.0,
                              ),
                            ),
              ...
              // Bottom navigation removed; handled globally by MainBottomNavWidget.
              Column(
                mainAxisSize: MainAxisSize.max,
                children: [
                  if (responsiveVisibility(
