...
class EventsEntertainmentScreenCopyCopyWidget extends StatefulWidget {
  const EventsEntertainmentScreenCopyCopyWidget({
    super.key,
    this.catagories,
  });
  ...
  static String routeName = 'EventsEntertainmentScreenCopyCopy';
  static String routePath = '/eventsEntertainmentScreenCopyCopy';

  @override
  State<EventsEntertainmentScreenCopyCopyWidget> createState() =>
                  ...
                  child: Column(
                    ...
                    children: [
                            ...
                            ClipRect(
                              child: ImageFiltered(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Image.asset(
                                    'assets/images/imageye___-_imgi_8_dji_fly_20240828_105026_23_1724872759726_photo-standard.png',
                                    width: double.infinity,
                                    height: 321.7,
                                    fit: BoxFit.cover,
                                  ),
                      ...
                      Padding(
                        ...
                        child: StreamBuilder<List<SubCatagoriesRecord>>(
                          stream: querySubCatagoriesRecord(
                            queryBuilder: (subCatagoriesRecord) =>
                                subCatagoriesRecord
                                    .where(
                                      'catagoriesRef',
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<SubCatagoriesRecord>
                                columnSubCatagoriesRecordList = snapshot.data!;
                            if (columnSubCatagoriesRecordList.isEmpty) {
                              return TextComponentWidget();
                            }

                            return Column(
                              mainAxisSize: MainAxisSize.max,
                              children: List.generate(
                                  columnSubCatagoriesRecordList.length,
                                  (columnIndex) {
                                final columnSubCatagoriesRecord =
                                    columnSubCatagoriesRecordList[columnIndex];
                                return Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 15.0, 0.0, 0.0),
                                  child: InkWell(
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      Get.toNamed(SubCatagoryScreenWidget.routePath, arguments: {'subCatagoriesRef': columnSubCatagoriesRecord});
                                    },
                                    child: Container(
                                      width: MediaQuery.sizeOf(context).width *
                                          0.9,
                          ...
                          children: [
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  20.0, 20.0, 20.0, 40.0),
                              child: Text(
                                'If there are any Events or Businesses you would like added, please contact us here or by email and we will get to you shortly.',
