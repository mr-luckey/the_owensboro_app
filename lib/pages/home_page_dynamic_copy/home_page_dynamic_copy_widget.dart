...
class HomePageDynamicCopyWidget extends StatefulWidget {
  const HomePageDynamicCopyWidget({super.key});

  static String routeName = 'HomePageDynamicCopy';
  static String routePath = '/homePageDynamicCopy';

  @override
  State<HomePageDynamicCopyWidget> createState() =>
      _HomePageDynamicCopyWidgetState();
}
                        ...
                        StreamBuilder<List<CatagoriesRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<CatagoriesRecord>
                                gridViewCatagoriesRecordList = snapshot.data!;
