...
/// GetX controller for [EventsEntertainmentScreenCopyWidget].
class EventsEntertainmentScreenCopyController extends GetxController {
  final GlobalKey<ScaffoldState> scaffoldKey = GlobalKey<ScaffoldState>();

  EventsEntertainmentScreenCopyModel? model;
  ...
  void initModel(BuildContext context) {
    ...
    model = createModel(context, () => EventsEntertainmentScreenCopyModel());
