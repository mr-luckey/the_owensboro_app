...
class ListingDetailPageCopy2Widget extends StatefulWidget {
  const ListingDetailPageCopy2Widget({
    super.key,
  ...
  static String routeName = 'ListingDetailPageCopy2';
  static String routePath = '/listingDetailPageCopy2';

  @override
  State<ListingDetailPageCopy2Widget> createState() =>
            ...
            children: [
              Padding(
                padding: EdgeInsets.all(valueOrDefault<double>(
                  MediaQuery.sizeOf(context).width >= 600.0 ? 50.0 : 20.0,
                  0.0,
                )),
